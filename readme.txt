...
Tags: contact form, simple contact form, oviex contact form, email contact form, contact us form, email contact us form,
...
Oviex Contact form is a simple contact form which works out of the box. Use shortcode on posts or pages to generate Oviex Contact Form. 
== Description ==

Oviex Contact form is a simple contact form which works out of the box. Use shortcode on posts or pages to generate Oviex Contact Form.Oviex Contact Form send all the submitted entries to admin specified email address.
...
1. Upload `oviex-contact-form.zip` to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Check the Oviex Contact Form menu in the left side navigation to know the shorcode or use `[ocf_contact_form]`
